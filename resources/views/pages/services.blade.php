...
<div class="body">
    ...
    <div class="row">
        <div class="col-lg-4" style="padding: 15px!important;">
            <div style="background-color:rgb(158, 196, 206)" class="service-list__content-box">
        ...
        <div class="col-lg-4" style="padding: 15px!important;">
            <div style="background-color:rgb(89, 199, 105)" class="service-list__content-box">
        ...
        <div class="col-lg-4" style="padding: 15px!important;">
            <div style="background-color:rgb(120, 158, 169)" class="service-list__content-box">
