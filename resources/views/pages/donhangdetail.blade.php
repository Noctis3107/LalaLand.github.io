...
<div class="body"style="margin-top:90px;">
    <h1 class="h3 mb-3 bg-light p-3" style="background-color:rgb(197, 237, 235) !important; "><strong>Đơn hàng đã đặt</strong></h1>
    ...
    @foreach ($showusers as $showuser)
        <div class="mb-3 bg-light p-3 my-3" style="background-color:rgb(189, 210, 208) !important;">
    ...
    <div class="mb-3">
        <table class="table table-hover my-0" style="background-color: rgb(202, 225, 222)">
            <thead>
                <th>Tên sản phẩm</th>
                <th>Số lượng</th>
                <th>Giá gốc</th>
            ...
            <tbody style="background-color: rgb(169, 219, 218)">
                @php
