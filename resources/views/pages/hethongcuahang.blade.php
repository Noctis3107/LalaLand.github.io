...
<div class="content-section">
    <div class="store-info">
        ...
        <div class="story">
            <h2>CÂU CHUYỆN</h2>
            <p>LalaLand tự hào là nơi hội tụ của những bộ sưu tập độc đáo, mỗi bộ là một hành trình khác biệt, một câu chuyện chưa kể. Bạn không cần phải lo lắng về sự ngẫu nhiên của những hộp blind box, mà thay vào đó, có thể lựa chọn những mô hình yêu thích từ các bộ sưu tập đã được định hình rõ ràng...</p>
        </div>

        <div class="destination">
            <h2>ĐÍCH ĐẾN</h2>
            <p>Chất lượng là điều LalaLand luôn hướng đến. Mỗi sản phẩm tại đây đều được làm từ các chất liệu cao cấp, đảm bảo độ bền đẹp và giá trị thẩm mỹ lâu dài. Đặc biệt, với dịch vụ giao hàng tận nơi nhanh chóng và thuận tiện, LalaLand mang đến cho bạn trải nghiệm mua sắm tuyệt vời...</p>
        </div>
