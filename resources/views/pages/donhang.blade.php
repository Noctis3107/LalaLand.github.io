...
<div class="card flex-fill">
  ...
  <table class="table table-hover my-0">
    <thead style="background-color: rgb(197, 233, 236)">
      <tr>
        <th>ID</th>
    ...
    <tbody style="background-color: rgb(204, 241, 238)">
      ...
      <tr>
        ...
        <td class="d-none d-md-table-cell"><a href="{{ route('donhang.edit', ['id' => $order->id_dathang]) }}" class="btn btn-primary" style="background-color: rgb(67, 149, 153)">Xem đơn hàng</a></td>
      </tr>
      <tr>
      @endforeach
    </tbody>
